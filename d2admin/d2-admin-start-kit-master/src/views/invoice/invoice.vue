...
<div class='container'>
	<!-- 1. 基本情報 -->
	<el-card style="box-sizing: border-box; padding: 0px 0 0 60px;">
		<div class='title'>
			<h3>1. 基本情報</h3>
		</div>
		<el-row :gutter="20">
			...
			<el-col :span="2">
				...
				<div>
					<el-select v-model="invoice.honorific" placeholder=" ">
	...
	<el-card style='margin-top: 15px;'>
					...
					<el-table-column align="center">
						<template slot-scope="props">
							<el-tooltip content='delete' placement="top" effect="light" :enterable="false">
								<el-button type='danger' icon='el-icon-delete' size='medium' @click='deleteTableitem(props.row)'>
								</el-button>
							</el-tooltip>
						</template>
					</el-table-column>
		...
		<el-card v-else >
			...
			<el-row >
				<el-form inline ref="newItemRef" :model="newitem" >
					<el-col :span="8">
						<div style="text-align:start; margin-bottom: 10px; padding-left: 10px;"><h4>品目名</h4></div>
			...
			<el-row :gutter="10" style="margin-top: 20px;">
				<el-col :span="2" >
					<el-button style='width: 100%; height: 30px;' type="success" @click='additem'>追加</el-button>
				</el-col>
				<el-col :span="2" >
					<el-button style='width: 100%; height: 30px' type="warning" @click='cancel'>戻る</el-button>
				</el-col>
			</el-row>
		</el-card>
	</el-card>
	...
	<el-card　style="margin-top: 15px;">
		...
		<el-row>
			<el-col :span="15">
				<div style="text-align:start; margin-bottom: 10px; margin-left: 10px;"><h4>振込先</h4></div>
				<el-input
				  type="textarea"
				  :rows="5"
				  placeholder="振込先"
		...
		<el-row>
			<el-col :span="15">
				<div style="text-align:start; margin-bottom: 10px; margin-left: 10px;"><h4>備考</h4></div>
				<el-input
				  type="textarea"
				  :rows="5"
				  placeholder="備考"
			...
			<el-row :gutter="10" style="margin-top: 50px; margin-left: 0;">
				<el-col :span="3">
					<el-button style='width: 100%; height: 50px;' type="success">
						請求者を生成
					</el-button>
				</el-col>
				<el-col :span="3" :push="1">
					<el-button style='width: 100%; height: 50px' type="warning">
						リセット
					</el-button>
				</el-col>
			</el-row>
